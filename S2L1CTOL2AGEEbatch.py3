...
def addMetadata(L2path,L2name,exportName,metadataName):
...
#20: "QA60", unsigned int16, EPS
            ...
            gdal.Translate(options.eDirname+exportName+' '+str(options.centerLon)+' '+str(options.centerLat)+' '+str(options.roiW)+'.tif',workDirname+'merged.vrt')
